...
from .franka_sort_ik_rel_mimic_env import FrankaCubeSortIKRelMimicEnv
from .franka_sort_ik_rel_mimic_env_cfg import FrankaCubeSortIKRelMimicEnvCfg
...
gym.register(
    id="Isaac-Sort-Cube-Franka-IK-Rel-Mimic-v0",
    entry_point="isaaclab_mimic.envs:FrankaCubeSortIKRelMimicEnv",
    kwargs={
        "env_cfg_entry_point": franka_sort_ik_rel_mimic_env_cfg.FrankaCubeSortIKRelMimicEnvCfg,
    },
    disable_env_checker=True,
)
...
##
# CPC Arm Stack Cube - IK Relative Pose Control
##

gym.register(
    id="Isaac-Stack-Cube-CpcArm-IK-Rel-Mimic-v0",
    entry_point=f"{__name__}.franka_stack_ik_rel_mimic_env:FrankaCubeStackIKRelMimicEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.cpc_arm_stack_ik_rel_mimic_env_cfg:CpcArmCubeStackIKRelMimicEnvCfg",
    },
    disable_env_checker=True,
)

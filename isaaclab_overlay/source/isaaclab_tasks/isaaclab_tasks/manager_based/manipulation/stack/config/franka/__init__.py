...
gym.register(
    id="Isaac-Sort-Cube-Franka-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": sort_joint_pos_env_cfg.FrankaCubeSortEnvCfg,
    },
    disable_env_checker=True,
)

gym.register(
    id="Isaac-Sort-Cube-Franka-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": sort_ik_rel_env_cfg.FrankaCubeSortEnvCfg,
        "robomimic_bc_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_rnn_low_dim.json"),
    },
    disable_env_checker=True,
)
